...
def seed():
    ...
    try:
        ...
        client1 = Client(
            ...
            disability_certificate_level="1級",
            address="東京都新宿区西新宿1-1-1",
            phone="090-1111-2222",
            emergency_contact="山田 花子（妻）",
            emergency_phone="090-3333-4444",
            staff_id=staff1.id,
            status="active",
            intake_date=date(2022, 4, 1),
        ...
        client2 = Client(
            ...
            disability_certificate_level="2級",
            address="東京都渋谷区代々木2-2-2",
            phone="080-5555-6666",
            emergency_contact="佐藤 良子（母）",
            emergency_phone="03-7777-8888",
            staff_id=staff1.id,
            status="active",
            intake_date=date(2023, 1, 15),
        ...
        client3 = Client(
            ...
            disability_certificate_level="療育手帳A",
            address="東京都豊島区池袋3-3-3",
            phone="090-9999-0000",
            emergency_contact="伊藤 幸子（母）",
            emergency_phone="03-1111-3333",
            staff_id=staff2.id,
            status="active",
            intake_date=date(2021, 7, 1),
            notes="グループホーム入居中。就労継続支援A型で農作業に従事。",
        )
        client4 = Client(
            name="渡辺 さくら",
            name_kana="ワタナベ サクラ",
            birth_date=date(2001, 3, 25),
            gender="女性",
            disability_type="発達障害",
            disability_certificate_level="精神障害者保健福祉手帳3級",
            address="東京都中野区中野4-4-4",
            phone="070-2222-3333",
            emergency_contact="渡辺 孝（父）",
            emergency_phone="090-4444-5555",
            staff_id=staff2.id,
            status="active",
            intake_date=date(2023, 6, 1),
        ...
        client5 = Client(
            ...
            gender="男性",
            disability_type="難病",
            disability_certificate_level="指定難病（パーキンソン病）",
            address="東京都目黒区目黒5-5-5",
            phone="03-6666-7777",
            emergency_contact="中村 由美子（妻）",
            emergency_phone="080-8888-9999",
            staff_id=staff1.id,
            status="active",
            intake_date=date(2022, 10, 1),
